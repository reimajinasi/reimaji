...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(
      // Using existing Button styles if possible, or hardcoding standard shadcn styles
      // Since Button component is custom, we might need to be careful.
      // But typically Action is a button.
      // Let's just use the className to style it like a button.
